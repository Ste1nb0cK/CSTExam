...
c autocorrelation (up to mc steps) and correlation time
      ...
      write(*,'(''autocorrelation time '',f40.10)')rkappa
c effective number of data
      write(*,'(''n, n eff             '',f40.10)')n/rkappa
c error of mean
      write(*,'(''statistical error    '',f40.10)')sqrt(v*rkappa/n)
      return
      end
